  ...
  EyeOff: ({ className = "w-5 h-5" }) => (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M13.878 10.414a3.5 3.5 0 00-4.875 4.875m3.536-3.536L15 12M3 3l18 18M9.88 9.88a9 9 0 00-5.12 2.12c1.274 4.057 5.064 7 9.542 7 1.455 0 2.825-.315 4.05-.88m-1.39-1.39a3 3 0 11-3.77-3.77m-1.39-1.39A9 9 0 0012 5c4.478 0 8.268 2.943 9.542 7a9 9 0 00-3.3 3.3"
      />
    </svg>
  ),
      ...
      <div className="w-full max-w-[420px] bg-white rounded-3xl border border-slate-100 p-8 shadow-xl shadow-slate-100/80 animate-fade-in">
        ...
        {successMessage && (
          <div className="bg-emerald-50 border border-emerald-100 text-emerald-800 rounded-2xl p-4 mb-5 flex items-start gap-3 text-xs">
            <div className="w-5 h-5 rounded-full bg-emerald-500 text-white flex items-center justify-center font-bold text-xs shrink-0 mt-0.5">
              ✓
            </div>
        ...
        >
          ...
          <div>
            ...
            {errors.oldPassword && (
              <p className="text-rose-500 text-[10px] font-bold mt-0.5 ml-1 animate-fade-in">
                {errors.oldPassword}
              </p>
            )}
          </div>
